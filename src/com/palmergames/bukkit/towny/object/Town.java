...
public class Town extends Government implements TownBlockOwner {
	...
	public int getTownBlockTypeLimit(TownBlockType type) {
		...
		return ((Map<String, Integer>) TownySettings.getTownLevel(this).get(TownySettings.TownLevel.TOWNBLOCKTYPE_LIMITS)).getOrDefault(type.getName().toLowerCase(Locale.ROOT), -1);
	}
